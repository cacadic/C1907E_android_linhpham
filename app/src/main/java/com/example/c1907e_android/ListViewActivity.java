...
public class ListViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentList.add(new Student("Lĩnh Phạm", "1", new Date(1992, 0,15)));
        studentList.add(new Student("Tân Tân", "2", new Date(1996,2,25)));
        studentList.add(new Student("Huy Huy", "3", new Date(1993,3,4)));
        studentList.add(new Student("Thanh Thanh", "4", new Date(1995,6,1)));
        studentList.add(new Student("Tùng Tùng", "5", new Date(1999,1,1)));
